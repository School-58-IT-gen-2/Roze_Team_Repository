...
Trader = NPC(name='Торговец-сталкер', money=100, texture='prothesis/_databases/photos_database/Sage.jpg', products = [all_weapons['кинжал пораженный коррозией'], all_weapons['магнитный крюк'], items['бинты'], items['ингалятор']], dialogue={'Кто ты?':'Я просто старый торгаш, живущий прекрасной жизнью странника.. а у тебя, вижу, жизнь далеко не скучная, хотя.. я бы сказал сложная. Зато в организме всегда хватает железа!', 'Как вы относитесь к машинам?':'Машины... они давно стали как люди. Если Главную систему обтянут кожей, я не отличу ее от моей тещи! ха-ха... в любом случае, этот конфликт не моего маленького ума дело, мне без разницы кто ты, путник, но учти, лучше в дальнейшем на конфликты не нарываться, у многих тут нейронных связей побольше будет. Если бы они ещё умели ими пользоваться..'}  )
Trader2 = NPC(name='Гуманоидный торговый автомат', money=60, texture='prothesis/_databases/photos_database/Sage.jpg', products = [all_weapons['кинжал пораженный коррозией'], all_weapons['магнитный крюк'], items['бинты'], items['ингалятор']], dialogue={'Кто ты?':'Я.. раньше был любимцем всех первых красоток - сушилка "Дайсон", а сейчас люди зачастую даже водой пользоваться бояться , какая там укладка..', 'Как ты относишься к людям?':'Люди.. я помню времена своей популярности, они покупали меня за бешенные деньги, потом совершенствовали.. Меня наделили многими свойствами, а потом забыли, в виду отсутствия надобности.. эх, вот бы снова быть самым желанным подарком на новый год...'}  )
